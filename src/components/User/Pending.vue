...
import ViewTickets from "@/components/User/ViewTickets.vue"
                ...
                <tr v-else v-for="ticket in paginatedPendingTickets" :key="ticket.id">
                    ...
                    <td class="d-flex justify-content-center align-items-center">
                        <div class="btn-group">
                            ...
                            <a class="btn btn-app bg-gray" :data-target="'#viewTicket' + ticket.id" data-toggle="modal"
                                style="margin-left: 10px;">
                                <i class="fas fa-eye"></i> View
                            </a>
                            <ViewTickets :ticket="ticket" :id="String(ticket.id)" />
