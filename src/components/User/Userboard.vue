...
import Resolved from "@/components/User/Resolved.vue";
import { ref } from "vue";

const countsTicket = JSON.parse(localStorage.getItem('user')) || {}
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <div class="small-box bg-gradient-info">
              <div class="inner">
                <h3>{{ countsTicket.ticketCount || 0 }}</h3>
                <p>Tickets Total</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-gradient-success">
              <div class="inner">
                <h3>{{ countsTicket.resolvedTickets || 0 }}</h3>
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-gradient-danger">
              <div class="inner">
                <h3>{{ countsTicket.pendingTickets || 0 }}</h3>
                <p>Tickets Pending</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-gradient-warning">
              <div class="inner">
                <h3>{{ countsTicket.processingTickets || 0 }}</h3>
              ...
              <div class="col-12">
                <div class="card bg-gradient-dark">
                  <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-ticket-alt mt-2"></i> Your Ticket Request Status:</h3>
